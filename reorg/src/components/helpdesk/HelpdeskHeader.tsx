      ...
      */}
      <div className="mx-6 hidden max-w-2xl flex-1 md:block">
        <div className="relative mx-auto">
          <Search className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-orange-500/80 dark:text-orange-400/85" />
          <input
            ...
            className={cn(
              "w-full rounded-md border border-orange-500/45 bg-surface pl-9 pr-9 text-sm text-foreground shadow-sm placeholder:text-orange-600/70 transition-colors focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-500/20 dark:placeholder:text-orange-400/70",
              ticketOpen ? "h-8" : "h-9",
            )}
